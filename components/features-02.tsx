      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Be the Host, Run the Show</h2>
            <p className="text-lg text-slate-400"> Organize Your Personal Poker Tournaments!</p>
          </div>
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0"  onClick={handleServices}>
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">Catering to your unique needs, Ace High Club provides tailored solutions to organize and elevate your private poker events, ensuring a memorable and rewarding experience for all participants.</p>
                          </div>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8" onClick={handleLeaderboard}>
                        ...
                        <div>
                          <a className="btn-sm text-slate-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none" href="#0">
                            <span className="relative inline-flex items-center">
                              Join now <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                            </span>
                          </a>
                        </div>
                      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50"> Trusted Environment </h4>
              </div>
              <p className="text-sm text-slate-400">Experience security and integrity with Ace High Club, where player protection is paramount.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Exclusive Access</h4>
              </div>
              <p className="text-sm text-slate-400">Gain entry to members-only games and events, reserved just for our community of skilled enthusiasts.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Premium Play</h4>
              </div>
              <p className="text-sm text-slate-400">Enjoy top-tier poker games with high-stakes excitement and premium rewards.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50"> Customized Experience</h4>
              </div>
              <p className="text-sm text-slate-400">Personalize your poker journey with customizable game settings and preferences.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Community Focus</h4>
              </div>
              <p className="text-sm text-slate-400">Connect with a network of players, from novices to pros, in our dedicated poker community.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Advanced Filtering</h4>
              </div>
              <p className="text-sm text-slate-400">"Find your perfect game with smart filtering that aligns with your skill level and interests.</p>
            </div>
          </div>
