      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">Dedicated to fair play, community spirit, and unwavering support, we're the trusted name in Sydney's poker scene</p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Secure Play & Community</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Connect and grow with fellow poker aficionados in a rich, interactive community setting.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Robust Security</h4>
                  </div>
                  <p className="text-sm text-slate-400">Safeguarding your sessions with state-of-the-art protections for peace of mind at every turn.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">User-Friendly Interface</h4>
                  </div>
                  <p className="text-sm text-slate-400">Intuitive and easy-to-use, our platform is designed for effortless access to all your poker needs.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Enhanced Experience & Insight</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Seamless Integrations</h4>
                  </div>
                  <p className="text-sm text-slate-400"> Sync with your life through seamless connections to your preferred tools and tech.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Advanced Analytics</h4>
                  </div>
                  <p className="text-sm text-slate-400">Sharpen your game with insightful analytics that spotlight your strengths and areas for improvement.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Real-Time Updates</h4>
                  </div>
                  <p className="text-sm text-slate-400">Stay ahead of the game with live notifications on your ranking, upcoming tournaments, and results.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Support & Accessibility</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">Our responsive team is here for you, ensuring a seamless poker experience with expert assistance.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Persistent Notifications</h4>
                  </div>
                  <p className="text-sm text-slate-400">Engage with the latest from Ace High Club with timely alerts on pivotal game moments and updates.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400"> Keep your game consistent across devices with flawless real-time synchronization.</p>
                </div>
              </div>
            </div>
          </div>
