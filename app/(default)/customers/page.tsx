        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 md:pt-40">
            ...
            <div className="text-center pb-12 md:pb-20">
              ...
              <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Full House of Features with Ace High Club</h1>
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-slate-400">Ace High Club offers an extensive suite of services designed to enhance your poker experience, from intuitive game interfaces to comprehensive player analytics.</p>
              </div>
            </div>
