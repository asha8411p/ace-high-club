      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40">
          ...
          <div className="text-center pb-12 md:pb-20">
            <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">Master the Tables</div>
            <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Clubs & Tournaments</h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-slate-400">Dive into the heart of the action with premier clubs and competitive tournaments where legends are born and victories are claimed.</p>
            </div>
          </div>
